 ...
 * @author Petar
 */
public class PredmetDaoImpl extends AbstractDao {
    ...
    @Override
    public synchronized Predmet vratiPoId(int predmetId) throws Exception {
        try {
...
//                predmetFromDb.setSadrzajTematskeCeline(sadrzajTematskeCeline);
                ...
                while (rs4.next()) {
                    Udzbenik udzbenik = UdzbenikDaoImpl.getInstance().vratiPoId(rs4.getInt("udzbenikId"));
                ...
                while (rs5.next()) {
                    ...
                    nnp.setNastavnik(NastavnikDaoImpl.getInstance().vratiPoId(rs5.getInt("nastavnikId")));
                    nnp.setPredmet(predmetFromDb);
                    nnp.setTipNastave(TipNastaveDaoImpl.getInstance().vratiPoId(rs5.getInt("tipNastaveId")));
    ...
    @Override
    public synchronized Predmet kreiraj(OpstiDomenskiObjekat odo) throws Exception {
        try {
...
//                ps3.close();
    ...
    @Override
    public synchronized Predmet azuriraj(OpstiDomenskiObjekat odo) throws Exception {
        Predmet predmet = (Predmet) odo;
        try {
...
//            ps7.close();
            ...
            return vratiPoId(predmet.getPredmetId());
        } catch (Exception e) {
    ...
    @Override
    public synchronized Predmet obrisi(OpstiDomenskiObjekat odo) throws Exception {
        Predmet predmet = (Predmet) odo;
        try {

            predmet = vratiPoId(predmet.getPredmetId());
